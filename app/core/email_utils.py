        ...
        <html>
            ...
            <body>
                ...
                <div class="info">
                    ...
                    Ten: {rescue_station.get('name', 'Khong xac dinh')}<br>
                    Khoang cach: {rescue_station.get('distance_km', 0):.2f} km<br>
                    Dien thoai: {rescue_station.get('phone', '112')}
                </div>
                
                <p style="color: red; font-weight: bold;">
                    HAY LIEN HE NGAY: {rescue_station.get('phone', '112')} hoac 112
                </p>
